      ...
      <section className="min-h-screen ">
        ...
        <div className="w-full min-h-96 lg:pt-9 mr-auto xl:w-[90%]">
          <div className="grid grid-cols-12 xl:gap-16">
                    ...
                    <div className="flex gap-x-3 items-center">
                      <div>
                        <img
                          src={
                            course?.courseImageh
                              ? `${baseUrl}${course.imagePath}${course.courseImage}`
            ...
            {/* Uncomment if needed */}
            <OrderSummary
              style="col-span-12 lg:col-span-6  xl:col-span-5 bg-dark rounded-xl mt-5 lg:mt-0 shadow-[4px_4px_0px_0px_#536CB3] container w-full md:w-custom-md xl:w-full"
              cartItems={cartItems}
              cartInfo={cartItems}
              // pricesInfo={info}
