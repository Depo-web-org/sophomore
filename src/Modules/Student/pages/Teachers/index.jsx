...
import { useCreateWishListMutation } from "../../../../Redux/data/postDataApiSlice";
...
const Teachers = () => {
  ...
  //     res.status === 0 &&toast.success("Added to WishList Successfuly!");
  //     res.status === 1 &&toast.error("Error While adding course to Your whislist!");
  //   }catch(err){
  //   console.log(err);
  //     }
  // }
