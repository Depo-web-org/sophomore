  ...
  return (
    ...
    <div className="min-h-screen ">
      <div className="relative bg-gradient-to-r from-secondary to-primary w-full h-48 rounded-tl-[100px] rounded-tr-lg mb-40">
        <div  className={`flex flex-col re lg:flex-row  items-center absolute -bottom-[75%] lg:-bottom-[50%] ${i18n.language === "en"?  "left-1/2 -translate-x-1/2 xl:translate-x-0  xl:left-[5%] justify-start " :""} w-full `}>
          ...
          <div className="text-center lg:text-left text-white mt-4 lg:mt-0 lg:ms-6">
            <p className="font-bold text-2xl">{student?.first_name?`${student?.first_name} ${student.last_name }`:"your name" }</p>
