    ...
    <div  className=" pb-10 lg:pb-0">
      ...
      <div className="w-full min-h-40 ">
        ...
        ">
          ...
          <div    className={`flex flex-col lg:flex-row justify-center items-center absolute -bottom-[70%] md:-bottom-[60%] mb-5 ${i18n.language === "en"? "left-1/2 -translate-x-1/2 xl:translate-x-0  xl:left-[5%]" :"right-1/2 translate-x-1/2 md:right-10   md:translate-x-0"}  `} >
          <img
          ...
          <div className="relative sm:px-4 pt-4 w-full   ">
              ...
              <p className="font-bold text-white text-2xl">{student?.first_name?`${student?.first_name} ${student.last_name }`:"your name" }</p>
      ...
      // ${i18n.language ===  "ar" ?  "ms-auto" :"m-auto"}
        ...
        className={`w-full px-4 lg:px-8 lg:w-[70%] min-h-96 ${i18n.language === "ar" ? "me-auto" : ""} `}
      >
        {/*first email */}
