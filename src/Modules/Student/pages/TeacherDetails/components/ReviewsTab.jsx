export default function ReviewsTab() {
  return (
    <section className="w-full flex flex-col items-start justify-start pr-12 ">
      <div className="grid grid-cols-1 gap-8">
        <div className="grid grid-cols-12 max-w-sm sm:max-w-full mx-auto border-b-[1px] border-gray-500">
          <div className="col-span-12 lg:col-span-10 ">
            <div className="sm:flex gap-6">
              ...
              />
              <div className="text">
                <p className="font-medium text-lg leading-8 text-white mb-2">
                  Robert Karmazov
                </p>
                ...
                <p className="font-normal text-sm leading-7 text-gray-400 mb-4 lg:pr-8">
                ...
                <div className="flex items-center justify-between">
                  <p className="lg:hidden font-normal text-sm leading-7 text-gray-400 lg:text-center whitespace-nowrap">
                    Nov 01, 2023
                  </p>
                </div>
              </div>
