  ...
  return (
    <>
      <div className=" flex items-start justify-start flex-col lg:gap-6 w-full ">
        <div className="flex justify-start items-start gap-4 lg:gap-8">
          ...
          <div className="flex items-start justify-start flex-col gap-2 lg:gap-3">
            <p className="text-2xl lg:text-4xl font-semibold leading-[24px] text-white">
              Omar Gad
            </p>
            <p className="text-sm md:text-base  font-normal leading-[18.75px] text-[#FFFFFF66]">
              Math Teacher
            </p>
...
export function AboutTab() {
  return (
    <div className="text-white flex items-start justify-start w-full lg:w-3/4 ">
      <p className="text-base lg:text-lg font-medium lg:font-semibold leading-[27px] ">
