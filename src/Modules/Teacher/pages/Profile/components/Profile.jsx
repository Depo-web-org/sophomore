  ...
  return (
    <div className="w-full min-h-40 ">
      <div className="relative bg-gradient-to-r from-[#F15C54] from-10%  to-[#536CB3] to-90% w-full h-48 rounded-tl-[100px] rounded-tr-lg">
        {/* icon */}
        <BsFillCameraFill className="absolute top-4 right-7 h-6 w-6 text-white x" />
        {/* img */}
        <img
          className="border-2 border-white absolute top-36 left-1/2 -translate-x-1/2 lg:-translate-x-0 lg:left-24 w-24 h-24 sm:w-32 sm:h-32 rounded-full"
      ...
      <div className="relative min-h-36 sm:px-4 py-4 w-full mt-10 sm:mt-0 sm:w-[60%] ms-auto px-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div >
            <p className="font-bold text-center lg:text-start  text-md">Sara  Gamal</p>
