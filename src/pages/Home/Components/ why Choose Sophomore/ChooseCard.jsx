export default function ChooseCard() {
  ...
  return (
    <section className="min-h-[498px] py-7">
      ...
      <div className="flex justify-center md:justify-between items-center flex-wrap gap-4 pt-6 ">
        {Sophomore.map((item) => {
          return (
            <>
              <div
                key={item.id}
                className="max-w-72 min-h-[252px] rounded-[5px] bg-white cursor-pointer flex flex-col items-center  justify-center gap-y-5 p-5"
              >
                <div>
                  <img
                    src={item.img}
                ...
                <p className="text-base font-medium leading-[18.75px] text-center text-black ">
                  {item.Name}
                </p>
                <p className="text-sm font-normal leading-[16.41px] text-center text-[#0000007D] ">
                  {item.dec}
                </p>
              </div>
            </>
